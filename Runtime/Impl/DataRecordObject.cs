namespace DRG.Data
{
    ...
    public sealed class DataRecordObject : ITypedDataRecord<object>
    {
        ...
        private class DataRecordObjectProxy<T> : ITypedDataRecord<T>
        {
            ...
            public void SetValue(T value) => dataRecordObject.SetValue(value);
            public T GetValue() => (T)dataRecordObject.GetValue();
            public void Apply() => dataRecordObject.Apply();
            public void Erase() => dataRecordObject.Erase();
        }
    }
}
